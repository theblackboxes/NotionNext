...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '23bda676bf07491cbcffc37659d8831c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '现代世界的“复魅”或“再入魅”，乃是对资本主义社会过度的物质化、世俗化和市场化的一种反拨，它以再神秘化为主要手段，引导人们的精身向度，引出对精神性的追求，作为对过度理性化（理性异化）的反拨。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'theblackboxes', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '研究哈利波特是兴趣爱好', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://theblackboxes.lofter.com/', // 网站地址
